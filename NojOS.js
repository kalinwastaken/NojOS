    ...
    for (let i = 0; i < lines; i++) {
        ...
        if (command == "help") {
            ...
            */
            ...
            command = command.substring(5,command.length).replaceAll("ALARM", alarm).replaceAll("MATH", global).replaceAll("USER", process.env.USERNAME).replaceAll("DATE", Date().substring(0,21));
            console.log(command);
        } else if (command == "date") {
            console.log(Date().substring(0,21));
        } else if (command == "specs") {
